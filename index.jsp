...
<form method="GET" id="sortForm">
    <select class="btn btn-outline-dark" style="margin-right:40px;" name="sort" id="sortSelect">
        ...
        <li >
          <a href="login.html" style="margin-right:40px;" class="btn btn-outline-dark">Login</a>
        </li>
        <li >
          <button type="button" style="margin-right:40px;" class="btn btn-outline-dark">signup/Register</button>
        </li>
      </ul>
    ...
    <div class="col-md-4">
      <div class="card product-card">
        ...
        <div class="card-body product-card-body">
          ...
          <button onclick="addItemToCart('<%= product.getProd_ID() %>', '<%= product.getProd_name() %>', '<%= product.getProd_price() %>')" class="btn btn-primary">Add to Cart</button>
        </div>
      </div>
    </div>
    <% 
